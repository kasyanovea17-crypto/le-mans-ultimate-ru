...
$sources=@((Join-Path $root 'src\Engine.cs'),(Join-Path $root 'src\Launcher.cs'),(Join-Path $build 'BuildInfo.cs'))
...
Write-Output 'BUILD_PASS launcher=1.0.0 payload=embedded dependencies=NET_Framework'
